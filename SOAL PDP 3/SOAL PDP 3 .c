...
int main()
{
    ...
    */
    ...
    printf("Jari Jari Kelereng = ");    scanf("%f",&jari_jari_kelereng);
    volume_kelereng = 1.33 * (3.14) * jari_jari_kelereng * jari_jari_kelereng;
    volume_air_tumpah = volume_tabung + volume_kelereng;
    printf("volume_tabung = alas_tabung * tinggi_tabung = %f\n",volume_tabung);
    printf("volume_kelereng = 1.33 * 3.14 * jarijarikelereng * jarijarikelereng = %f\n",volume_kelereng);
    printf("Volume Air Tumpah = volume tabung + volume kelereng = %f\n", volume_air_tumpah, volume_kelereng, volume_tabung);
    return 0;
}
